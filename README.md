...
<div style="text-align:right;">![.htaccess logo](https://github.com/o10n-x/wordpress-css-optimization/blob/master/admin/images/htaccess-logo.png)</div>

# WordPress .htaccess Editor

Advanced Apache .htaccess editor for optimization purposes.

* [Documentation](https://github.com/o10n-x/wordpress-htaccess-editor/tree/master/docs)
* [Description](https://github.com/o10n-x/wordpress-htaccess-editor#description)
* [Version history (Changelog)](https://github.com/o10n-x/wordpress-htaccess-editor/releases)
...
This plugin is a .htaccess editor with code highlighting for optimization purposes.

![.htaccess editor](https://github.com/o10n-x/wordpress-htaccess-editor/blob/master/docs/images/htaccess-editor.png)

Additional features can be requested on the [Github forum](https://github.com/o10n-x/wordpress-htaccess-editor/issues).
